...
public class StringIntMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, int>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csharpaidiclientPINVOKE.delete_StringIntMap(swigCPtr);
        }
  ...
  public StringIntMap() : this(csharpaidiclientPINVOKE.new_StringIntMap__SWIG_0(), true) {
  }
  ...
  private uint size() {
    uint ret = csharpaidiclientPINVOKE.StringIntMap_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = csharpaidiclientPINVOKE.StringIntMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    csharpaidiclientPINVOKE.StringIntMap_Clear(swigCPtr);
  }

  private int getitem(string key) {
    int ret = csharpaidiclientPINVOKE.StringIntMap_getitem(swigCPtr, key);
    if (csharpaidiclientPINVOKE.SWIGPendingException.Pending) throw csharpaidiclientPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, int x) {
    csharpaidiclientPINVOKE.StringIntMap_setitem(swigCPtr, key, x);
    if (csharpaidiclientPINVOKE.SWIGPendingException.Pending) throw csharpaidiclientPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = csharpaidiclientPINVOKE.StringIntMap_ContainsKey(swigCPtr, key);
    if (csharpaidiclientPINVOKE.SWIGPendingException.Pending) throw csharpaidiclientPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, int val) {
    csharpaidiclientPINVOKE.StringIntMap_Add(swigCPtr, key, val);
    if (csharpaidiclientPINVOKE.SWIGPendingException.Pending) throw csharpaidiclientPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = csharpaidiclientPINVOKE.StringIntMap_Remove(swigCPtr, key);
    if (csharpaidiclientPINVOKE.SWIGPendingException.Pending) throw csharpaidiclientPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = csharpaidiclientPINVOKE.StringIntMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = csharpaidiclientPINVOKE.StringIntMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    csharpaidiclientPINVOKE.StringIntMap_destroy_iterator(swigCPtr, swigiterator);
  }
