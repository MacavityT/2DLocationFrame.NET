...
namespace ApplyHalcon
{
    class FindModel
    {
            ...
            out HTuple hv_ColCenter, out HTuple hv_Radius)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    //image_point_in_world(hv_RowCenter, hv_ColCenter, out hv_RowCenter, out hv_ColCenter);
                }
                // catch (Exception) 
            ...
            try
            {
                ...
                try
                {
                        ...
                        hv_Step * 0.5))) != 0)
                    {
                        ...
                        //image_point_in_world(hv_LineRow1, hv_LineCol1, out hv_LineRow1, out hv_LineCol1);
                        //image_point_in_world(hv_LineRow2, hv_LineCol2, out hv_LineRow2, out hv_LineCol2);
                    }
                }
                // catch (Exception) 
                catch (HalconException HDevExpDefaultException1)
        ...
        public static void image_point_in_world(HTuple hv_ImageRow, HTuple hv_ImageCol, out HTuple hv_WorldRow,
            out HTuple hv_WorldCol)
        {
            ...
            // Initialize local and output iconic variables 
            //Calibration 03: Code generated by Calibration 03 -- collect images on wrong desk...
            //CameraParameters := [0.0361311,-255.17,17.3289,264.664,3.46549e-006,3.45e-006,1263.53,982.218,2448,2048]
            //CameraPose := [-0.00497858,0.0012356,0.41697,358.34,344.276,359.933,0]

            //Calibration 01: Code generated by Calibration 01 -- collect images on correct desk
            //CameraParameters := [0.3908,-226.589,3.74515,259.139,3.46559e-006,3.45e-006,1540.63,1083.13,2448,2048]
            //CameraPose := [-0.0138782,0.00173064,4.45094,6.43966,359.863,359.104,0]

            //Calibration 01: Code generated by Calibration 01 -- robot taught user frame, try to make cam / work plane parellel
            //CameraParameters := [0.035,289.812,-110447,9.6134e+008,0.0804097,-1.62539,3.38068e-006,3.45e-006,1520.46,-689.303,2448,2048]
            //CameraPose := [-0.0108224,0.0711646,0.410733,0.574131,0.272598,358.921,0]

            //Calibration 03: Code generated by Calibration 03
            hv_CameraParameters = new HTuple();
            hv_CameraParameters[0] = 0.0349151;
            hv_CameraParameters[1] = -255.258;
            hv_CameraParameters[2] = 16.7297;
            hv_CameraParameters[3] = 232.197;
            hv_CameraParameters[4] = 3.43471e-006;
            hv_CameraParameters[5] = 3.45e-006;
            hv_CameraParameters[6] = 1360.95;
            hv_CameraParameters[7] = 919.675;
            hv_CameraParameters[8] = 2448;
            hv_CameraParameters[9] = 2048;
            hv_CameraPose = new HTuple();
            hv_CameraPose[0] = -0.0109043;
            hv_CameraPose[1] = 0.00776261;
            hv_CameraPose[2] = 0.393097;
            hv_CameraPose[3] = 349.903;
            hv_CameraPose[4] = 346.867;
            hv_CameraPose[5] = 359.266;
            hv_CameraPose[6] = 0;


            //CameraParameters := ['area_scan_tilt_division',0.0354652,-229.021,0.0210793,9.12259,188.047,3.51938e-006,3.45e-006,1223.88,1023.86,2448,2048]
            //CameraPose := [-0.00359841,-0.000400561,0.401512,344.84,359.377,0.0830362,0]
            HOperatorSet.ImagePointsToWorldPlane(hv_CameraParameters, hv_CameraPose, hv_ImageRow,
                hv_ImageCol, "mm", out hv_WorldRow, out hv_WorldCol);
            ...
            out HTuple hv_RowCross, out HTuple hv_ColCross, out HTuple hv_Phi, out HTuple hv_IsOverlapping)
        {
            ...
            HTuple newPhi1 = new HTuple();
            HTuple newPhi2 = new HTuple();
            HOperatorSet.TupleAtan2(hv_LineLeftRow2 - hv_LineLeftRow1, hv_LineLeftCol2 - hv_LineLeftCol1, out newPhi1);
            HOperatorSet.TupleAtan2(hv_LineUpRow2 - hv_LineUpRow1, hv_LineUpCol2 - hv_LineUpCol1, out newPhi2);
            hv_Phi = new HTuple((newPhi1.D + newPhi2.D) / 2);
        }
    }
}
