...
namespace ApplyHalcon
{
    class FindModel
    {
            ...
            out HTuple hv_WorldCol)
        {
            ...
            hv_CameraParameters[0] = 0.3908;
            hv_CameraParameters[1] = -226.589;
            hv_CameraParameters[2] = 3.74515;
            hv_CameraParameters[3] = 259.139;
            hv_CameraParameters[4] = 3.46559e-006;
            hv_CameraParameters[5] = 3.45e-006;
            hv_CameraParameters[6] = 1540.63;
            hv_CameraParameters[7] = 1083.13;
            hv_CameraParameters[8] = 2448;
            hv_CameraParameters[9] = 2048;
            hv_CameraPose = new HTuple();
            hv_CameraPose[0] = -0.0138782;
            hv_CameraPose[1] = 0.00173064;
            hv_CameraPose[2] = 4.45094;
            hv_CameraPose[3] = 6.43966;
            hv_CameraPose[4] = 359.863;
            hv_CameraPose[5] = 359.104;
            hv_CameraPose[6] = 0;
