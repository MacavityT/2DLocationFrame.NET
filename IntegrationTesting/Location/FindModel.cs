...
namespace ApplyHalcon
{
    class FindModel
    {
            ...
            out HTuple hv_WorldCol)
        {
            ...
            hv_CameraParameters[0] = 0.0361311;
            hv_CameraParameters[1] = -255.17;
            hv_CameraParameters[2] = 17.3289;
            hv_CameraParameters[3] = 264.664;
            hv_CameraParameters[4] = 3.46549e-006;
            hv_CameraParameters[5] = 3.45e-006;
            hv_CameraParameters[6] = 1263.53;
            hv_CameraParameters[7] = 982.218;
            hv_CameraParameters[8] = 2448;
            hv_CameraParameters[9] = 2048;
            hv_CameraPose = new HTuple();
            hv_CameraPose[0] = -0.00497858;
            hv_CameraPose[1] = 0.0012356;
            hv_CameraPose[2] = 0.41697;
            hv_CameraPose[3] = 358.34;
            hv_CameraPose[4] = 344.276;
            hv_CameraPose[5] = 359.933;
            hv_CameraPose[6] = 0;
